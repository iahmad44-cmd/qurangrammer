const lessons = [
  ...
  { id: "17", number: "17", urTitle: "اسمائے اشارہ بطور مبتدا", urTopics: "اسمائے اشارہ کے جدول؛ ہائے تنبیہ؛ غیر عاقل کی جمع؛ ذٰلِكَ الْكِتَابُ کی بلاغت؛ کافِ خطاب", enTitle: "Asma' ul Isharah as Mubtada", enTopics: "Tables of the Asma' ul Isharah; the Haa' ut Tanbeeh; plurals of the Ghayr 'Aqil; the rhetoric of Dhalika al-Kitab; the Kaf ul Khitab", files: { ur: { pdf: true }, en: { pdf: true } } },
  { id: "18", number: "18", urTitle: "جملۂ اسمیہ — ضمائر بطور مبتدا", urTopics: "جملۂ اسمیہ کے اجزاء؛ اسمِ ضمیر؛ لفظ ضمائر کی گرامر؛ غائب، مخاطب اور متکلم ضمائر", enTitle: "Jumla Ismiyyah — Dama'ir as Mubtada", enTopics: "The parts of a Jumla Ismiyyah; Ism ud Dameer; the grammar of Dama'ir; third-, second- and first-person pronouns", files: { ur: { pdf: true }, en: { pdf: true } } },
  { id: "19", number: "19", urTitle: "اسمائے موصولہ بطور مبتدا", urTopics: "اسمائے موصولہ کا تعارف اور معانی؛ قرآنی مثالیں؛ واحد، تثنیہ اور جمع؛ مکمل جدول", enTitle: "Asma' ul Mawsulah as Mubtada", enTopics: "Introduction and meanings of the relative pronouns; Qur'anic examples; singular, dual and plural; the complete table", files: { ur: { pdf: true }, en: { pdf: true } } },
  { id: "20-21", number: "20–21", urTitle: "مرکباتِ ناقصہ — مرکبِ توصیفی", urTopics: "مفرد اور مرکب؛ صفت و موصوف؛ ترتیب کا قاعدہ؛ جنس، عدد، وسعت اور اعراب میں مطابقت", enTitle: "Murakkabat Naqisah — the Murakkab Tawsifi", enTopics: "Mufrad and Murakkab; Sifah and Mawsuf; order; agreement in gender, number, definiteness and I'raab", files: { ur: { pdf: true }, en: { pdf: true } } },
  { id: "22", number: "22", urTitle: "مرکبِ اشاری", urTopics: "مرکبِ اشاری کی تعریف؛ اسمِ اشارہ اور مشارٌ الیہ؛ مطابقت کے قواعد؛ قرآنی مثالیں", enTitle: "The Murakkab Isharee", enTopics: "The demonstrative construction; Ism ul Isharah and Mushar Ilayh; agreement rules; Qur'anic examples", files: { ur: { pdf: true }, en: { pdf: true } } },
  { id: "23", number: "23", urTitle: "مرکبِ اضافی", urTopics: "اضافت؛ مضاف و مضاف الیہ؛ ترتیب اور ترجمے کی علامات؛ اعراب کے قواعد", enTitle: "The Murakkab Idafi", enTopics: "Idafah; Mudaf and Mudaf Ilayh; order and translation markers; rules of I'raab", files: { ur: { pdf: true }, en: { pdf: true } } },
  { id: "24", number: "24", urTitle: "پیچیدہ مرکبِ اضافی", urTopics: "ایک سے زیادہ مضاف و مضاف الیہ؛ اضافت کی زنجیر؛ اعراب کا تجزیہ؛ حدیث اور قرآنی مثالیں", enTitle: "The complex Murakkab Idafi", enTopics: "Multiple Mudaf and Mudaf Ilayh; chains of Idafah; I'raab analysis; Hadith and Qur'anic examples", files: { ur: { pdf: true }, en: { pdf: true } } },
  { id: "25", number: "25", urTitle: "مرکبِ اضافی میں ضمائر", urTopics: "ضمیرِ مجرور متصل؛ مضاف الیہ کی جگہ ضمائر؛ مرفوع و مجرور ضمائر؛ اعراب", enTitle: "Dama'ir in the Murakkab Idafi", enTopics: "Dameer Majroor Muttasil; pronouns as Mudaf Ilayh; Marfoo' and Majroor pronouns; I'raab", files: { ur: { pdf: true }, en: { pdf: true } } },
  { id: "26", number: "26", urTitle: "مرکبِ اضافی — استثناء اور اسمائے ستہ", urTopics: "ضمیر ـهُ کے قواعد؛ سورۃ عبس میں اطلاق؛ قرآنی استثنائی صورتیں؛ اسمائے ستہ کا اعراب", enTitle: "Murakkab Idafi — exceptions and Asma' Sittah", enTopics: "Rules for Dameer -hu; Surah 'Abasa; Qur'anic exceptions; I'raab of the Asma' Sittah", files: { ur: { pdf: true }, en: { pdf: true } } }
];

const copy = {
  ur: { description: "عربی قواعد کے تفصیلی مطالعے کے نوٹس · اسباق ۱ تا ۲۶", overline: "سنجیدہ مطالعے کے لیے منظم ذخیرہ", kicker: "مطالعہ کا ذخیرہ", title: "تمام اسباق", intro: "قرآنی عربی کی زبان، ساخت اور بلاغت کا تدریجی نصاب۔", label: "اسباق تلاش کریں", placeholder: "عنوان یا موضوع لکھیں…", pdf: "پی ڈی ایف کھولیں", docx: "ورڈ فائل", unavailable: "جلد دستیاب", found: n => `${n.toLocaleString("ur-PK")} اسباق`, empty: "کوئی سبق نہیں ملا۔", footer: "اے میرے رب، میرے علم میں اضافہ فرما۔", about: "عربی کے طلبہ کے لیے دو لسانی مطالعاتی ذخیرہ۔", stats: ["اسباق", "زبانیں", "آن لائن مطالعہ", "آف لائن مطالعہ"], formats: "پی ڈی ایف اور قابلِ تدوین نوٹس", note: "", ariaPdf: n => `سبق ${n} کی پی ڈی ایف کھولیں`, ariaDocx: n => `سبق ${n} کی ورڈ فائل ڈاؤن لوڈ کریں` },
  en: { description: "Detailed study notes on Arabic grammar · Lessons 1–26", overline: "A structured library for serious study", kicker: "Study library", title: "All lessons", intro: "A progressive course in the language, structure and eloquence of Quranic Arabic.", label: "Search lessons", placeholder: "Search by title or topic…", pdf: "Open PDF", docx: "Word file", unavailable: "Coming soon", found: n => `${n} lesson${n === 1 ? "" : "s"}`, empty: "No lessons found.", footer: "My Lord, increase me in knowledge.", about: "A bilingual study archive for students of Arabic.", stats: ["Lectures", "Languages", "Read online", "Study offline"], formats: "PDF and editable notes", note: "", ariaPdf: n => `Open lesson ${n} as PDF`, ariaDocx: n => `Download lesson ${n} as a Word file` }
};
...
function render() {
  ...
  filtered.forEach(lesson => {
    const file = { ...(lesson.files[language] || {}), docx: true };
